...
echo " "
mpirun -np 4 ./SSSP_MPI --sourceNode 0 --strategy 1 --inputFile "input_graphs/GG_Test"
echo " "
mpirun -np 4 ./SSSP_MPI --sourceNode 0 --strategy 2 --inputFile "input_graphs/GG_Test"
echo " "
...
echo " "
mpirun -np 4 ./SSSP_MPI --sourceNode 2 --strategy 1 --inputFile "input_graphs/GG_Test"
echo " "
mpirun -np 4 ./SSSP_MPI --sourceNode 2 --strategy 1 --inputFile "input_graphs/GG_Test"
